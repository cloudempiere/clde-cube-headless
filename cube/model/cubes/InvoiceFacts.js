cube(`Invoicefacts`, {
  ...
  preAggregations: {
    ...
    invoicesByMonth: {
      ...
      dimensions: [Client.ad_client_id, Invoicefacts.issotrx],
    ...
    //   type: `rollup`,
    //   measures: [count],
    //   dimensions: [Client.ad_client_id, ad_client_id, issotrx]
    // },

    // pterm: {
    //   type: `rollup`,
    //   //   measures: [linenetamt],
    //   dimensions: [Client.ad_client_id, c_paymentterm_name, issotrx, dateinvoiced],
    //   timeDimension: dateinvoiced,
    //   granularity: `day`
    // },
    ...
    //     update_window: `7 day`
    //   },
    //   measures: [linecount, qtyinvoiced, linepricelimit, linepricelist, linenetamt, linetotalamt, marginamt, discount, margin, markup, fraction],
    //   dimensions: [Client.ad_client_id, ad_org_id, c_bpartner_id, m_product_id, salesrep_id, ad_org_name, c_invoiceline_id, bpartner, salesrep, prodcategory, product, c_paymentterm_name],
