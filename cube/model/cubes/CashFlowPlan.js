...
order by cpl.DateTrx ASC
  ...
  preAggregations: {
    ...
    byMonth: {
      type: `rollup`,
      measures: [Cashflowplan.count, Cashflowplan.cashamt, Cashflowplan.cashin, Cashflowplan.cashout],
      dimensions: [Cashflowplan.ad_client_id],
      timeDimension: Cashflowplan.Date,
      granularity: `day`,
