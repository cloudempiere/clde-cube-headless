...
cube(`Quotefacts`, {
    ...
    byMonth: {
      type: `rollup`,
      measures: [Quotefacts.linecount, Quotefacts.qtyquoted, Quotefacts.linenetamt, Quotefacts.linetotalamt],
      dimensions: [Quotefacts.ad_client_id],
      timeDimension: Quotefacts.datequoted,
      granularity: `day`,
    ...
    //     update_window: `7 day`
    //   },
    //   measures: [count, linenetamt, linepricelimit, marginamt, qtyquoted],
    //   dimensions: [Client.ad_client_id, salesrep],
    //   useOriginalSqlPreAggregations: true,
    //   timeDimension: datequoted,
    ...
    //     update_window: `7 day`
    //   },
    //   measures: [linecount, count, linenetamt, linepricelimit, marginamt, qtyquoted],
    //   dimensions: [Client.ad_client_id, organization, product, prodcategory, salesrep, bpartner, datequoted],
    //   timeDimension: datequoted,
    //   partition_granularity: `year`,
    //   granularity: `day`,
    //   scheduledRefresh: true,
    ...
    //   },
    //   measures: [linecount, count, linenetamt, linepricelimit, marginamt, qtyquoted],
    //   dimensions: [Client.ad_client_id, organization, product, prodcategory, salesrep, bpartner, datepromised],
    //   timeDimension: datequoted,
    //   partition_granularity: `year`,
    //   granularity: `day`,
    //   scheduledRefresh: true,
